...
tests = test [
        ...
        "publicacionesDe tiene varios usuarios sin publicaciones"
        "publicacionesDe tiene varios usuarios con 1 publicacion"
        "publicacionesDe tiene varios usuarios con varias publicaciones"
    ]
